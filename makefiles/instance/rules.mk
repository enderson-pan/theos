...
MDFLAGS = -MP -MT "$@ $(subst .md,.o,$@)" -MM -D__arm64__
...
$(THEOS_OBJ_DIR)/%.mm.$(_THEOS_OBJ_FILE_TAG).md: %.mm
	$(ECHO_NOTHING)$(TARGET_CXX) -x objective-c++ -c $(filter-out -arch_%,$(subst arch ,arch_,$(ALL_CFLAGS) $(ALL_OBJCFLAGS) $(ALL_CCFLAGS) $(ALL_OBJCCFLAGS))) $< $(MDFLAGS) -o $@$(ECHO_END)
